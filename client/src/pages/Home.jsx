...
export default function Home() {
  ...
  return (
    <div style={{ minHeight:'100vh' }}>
      ...
      {/* ─── DESKTOP NAV ─── */}
      {/* Desktop nav — completely removed from DOM on mobile via CSS */}
      <nav className="desktop-nav" style={{ position:'sticky', top:0, zIndex:200, background:'rgba(9,9,15,0.96)', backdropFilter:'blur(24px)', borderBottom:'1px solid var(--b1)' }}>
