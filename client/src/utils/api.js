...
export const adminGetLive        = ()       => api.get(`${A}/live/all`)
export const adminEditLive       = (id, d)  => api.patch(`${A}/live/${id}`, d)
export const adminDeleteLive     = (id, d)  => api.delete(`${A}/live/${id}`, { data: d })
